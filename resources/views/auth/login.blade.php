...
<div class="relative flex min-h-screen items-center justify-center overflow-hidden p-8">
    <div class="glass-lg relative flex w-full max-w-[420px] flex-col gap-5 p-8">
        <div class="flex flex-col gap-1.5">
            <a href="/" class="eyebrow no-underline">Masuk</a>
            ...
            <p class="t-body max-w-[44ch]" style="font-size: var(--fs-body-s)">Gunakan akun kerja Anda untuk melanjutkan ke panel penempatan gudang.</p>
        </div>
        ...
        <form class="flex flex-col gap-3.5" method="POST" action="{{ route('login') }}">
            @csrf
            <div class="field">
            ...
            <div class="field">
                ...
                <input id="password" name="password" type="password" required autocomplete="current-password" minlength="8" placeholder="Minimal 8 karakter" class="field__input">
            </div>
            ...
            <button type="submit" class="btn btn--primary btn--full">Masuk ke panel</button>

            <p class="footnote text-center" style="letter-spacing: normal; text-transform: none">
                Belum punya akun? <a href="/register" style="color: var(--c-cobalt)">Daftar di sini</a>
            </p>
        </form>
    </div>
</div>
